...
#Variance intra date
m1 <- lme4::lmer(log(Nb_eggs+1) ~ Test_environment +  (1|Date_P) + (1|BoxID), data = data_PREF,  REML=TRUE)
m2 <- lme4::lmer(log(Nb_eggs+1) ~ Test_environment + (1|BoxID), data = data_PREF,  REML=TRUE)
