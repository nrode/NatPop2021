...
#Perform siluations
sim <- sapply(1:nb_simul, simul_fitnessdata_normal, rho = -0.05, rho_ng = -0.05, 
              sdpophab = 0.5, sdpophab_ng = 0.5, sigma = 0.5, nrep=10)
...
#Perform siluations
sim <- sapply(1:nb_simul, simul_fitnessdata_binomial, rho = -0.05, rho_ng = -0.05, 
              sdpophab = 0.5, sdpophab_ng = 0.5, sigma = 0.5, nrep=10)
sim <- as.data.frame(t(sim))
...
```{r } 
nb_simul
sim <- sapply(1:nb_simul, simul_fitnessdata_binomial, rho=0, rho_ng=0, sigma = 0.5, nrep=10)
sim <- as.data.frame(t(sim))
sim <- add_indic_sign(sim)
...
sim <- sapply(1:nb_simul, simul_fitnessdata_binomial, rho=-0.1, rho_ng=0, sigma = 0.5, nrep=10)
sim <- as.data.frame(t(sim))
sim <- add_indic_sign(sim)
...
sim <- sapply(1:nb_simul, simul_fitnessdata_binomial, rho=0, rho_ng=-0.1, sigma=0.5, nrep=10)
sim <- as.data.frame(t(sim))
sim <- add_indic_sign(sim)
