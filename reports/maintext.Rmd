...
m <- lmer(asin(sqrt(Rate))~ SA + SA*IndicG0 + Test_environment:Generation  + (1|Population:Test_environment) + (0 + dummy(Generation, "G0")|Population:Test_environment), data=data_PERF_Rate[!is.na(data_PERF_Rate$Rate),])
summary(m)
